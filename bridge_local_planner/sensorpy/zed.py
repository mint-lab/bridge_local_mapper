...
def print_zed_info(zed:ZED):
    ...
    print(f'  * Model     : {zed_info.camera_model}')
    print(f'  * Serial    : {zed_info.serial_number}')
    print(f'  * Connection: {zed_info.input_type}')
    cam_info = zed_info.camera_configuration
    print(f'  * Firmware  : {cam_info.firmware_version}')
    print(f'  * Resolution: {cam_info.resolution.width}x{cam_info.resolution.height} (FPS: {cam_info.fps})')
    print('')
    print('* Intrinsic parameters')
    param = zed_info.camera_configuration.calibration_parameters.left_cam
    print(f'  * Left : fx={param.fx}, fy={param.fy}, cx={param.cx}, cy={param.cy}, dist={param.disto}')
    param = zed_info.camera_configuration.calibration_parameters.right_cam
    print(f'  * Right: fx={param.fx}, fy={param.fy}, cx={param.cx}, cy={param.cy}, dist={param.disto}')
    print('')
    print('* Extrinsic parameters')
    param = zed_info.camera_configuration.calibration_parameters.stereo_transform
    print(f'  * R: {param.get_rotation_matrix().r}')
    print(f'  * T: {param.get_translation().get()}')
    print('')
